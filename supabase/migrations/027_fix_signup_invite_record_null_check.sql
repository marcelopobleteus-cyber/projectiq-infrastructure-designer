-- Migration: 027_fix_signup_invite_record_null_check.sql
-- Description: Fixes record nullness check in handle_new_user_provisioning so that
-- invitations with nullable columns (like invited_by = NULL) are properly recognized on signup.
