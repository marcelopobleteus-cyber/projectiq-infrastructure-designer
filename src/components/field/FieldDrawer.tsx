...
export default function FieldDrawer({
  ...
  const handleSwitchToDesktop = () => {
    ...
    } else if (pathname.includes('/field/time')) {
  ...
  const globalNav = [
    { label: 'Dashboard', href: '/field/dashboard', icon: '📊' },
    { label: 'Project List', href: '/field/projects', icon: '📁' },
    { label: 'Time Card', href: '/field/time', icon: '⏱️' },
    { label: 'Executive Reports', href: '/field/reports', icon: '📈' },
    { label: 'Settings', href: '/field/settings', icon: '⚙️' },
  ]

  const projectNav = projectId
    ? [
        { label: 'Project Overview', href: `/field/projects/${projectId}/overview`, icon: '🏠' },
        { label: 'Cameras (CCTV)', href: `/field/projects/${projectId}/cameras`, icon: '📸' },
        { label: 'Fiber Optic (OSP/ISP)', href: `/field/projects/${projectId}/fiber`, icon: '🧬' },
        { label: 'Networking & Switches', href: `/field/projects/${projectId}/network`, icon: '🔌' },
        { label: 'Bill of Materials (BOM)', href: `/field/projects/${projectId}/bom`, icon: '📦' },
        { label: 'Work Orders (Tasks)', href: `/field/projects/${projectId}/tasks`, icon: '📋' },
      ]
    : []
