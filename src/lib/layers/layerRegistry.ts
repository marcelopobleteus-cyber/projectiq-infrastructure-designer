...
export const LAYERS: LayerDefinition[] = [
  ...
  },
  {
    id: 'ptmp-links',
    name: 'PTMP Links',
    description: 'Wireless sector coverage and client links',
    defaultVisible: false,
    editable: false,
    icon: 'wireless-ptmp',
    color: '#f43f5e',
  ...
  },
  {
    id: 'lte-5g-backup',
    name: 'LTE / 5G Backup',
    description: 'Cellular modems, signal levels, and SIM allocations',
    defaultVisible: false,
    editable: false,
    icon: 'cellular',
    color: '#fda4af',
...
export const CATEGORY_MAPPINGS: Record<LayerCategory, string[]> = {
  ...
  'Wireless': ['ptp-links', 'ptmp-links', 'lte-5g-backup'],
