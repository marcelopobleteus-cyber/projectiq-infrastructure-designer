              ...
              {isOrgAdmin && (
                <div className="flex items-center gap-3 pt-1">
                  <button
                    ...
                    className="px-3.5 py-2 bg-[var(--accent)] disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-bold rounded-lg transition cursor-pointer shadow-xs"
                  >
            ...
            <div className="flex items-center justify-between">
              ...
              {isOrgAdmin && (
                <button
                  ...
                  className="px-4 py-2 bg-[var(--accent)] text-white rounded-lg text-xs font-bold transition flex items-center gap-1.5 shadow-xs cursor-pointer"
                >
