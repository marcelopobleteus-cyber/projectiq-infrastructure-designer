...
export default async function FieldOverviewStubPage({ params }: FieldOverviewProps) {
      ...
      <div className="space-y-4 font-sans">
        <div className="bg-[var(--surface-1)] border border-[var(--border)] p-6 rounded-2xl text-center space-y-3">
          ...
          <p className="text-xs text-[var(--text-secondary)] max-w-xs mx-auto leading-relaxed">
            Field project overview (<code className="text-[var(--accent-text)] font-mono">{projectId}</code>). The adapted panel will be built in the next phase.
          </p>
        </div>
      </div>
    </FieldAppShell>
