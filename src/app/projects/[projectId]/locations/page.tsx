    ...
    <div className="space-y-6 relative z-10 w-full max-w-7xl mx-auto px-6 py-4 font-sans text-slate-300">
      ...
      <div className="bg-indigo-950/15 border border-indigo-900/30 rounded-2xl p-4 text-xs flex gap-3 text-indigo-400">
        ...
        <div>
          ...
          <p className="text-slate-400 mt-1">NextQ currently runs on a single primary layout grid. Future releases will support nesting multiple sites and sub-grids (e.g. separate server rooms, secondary yards) under a single project.</p>
        </div>
      </div>
